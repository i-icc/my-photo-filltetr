...
import init, { film_effect_1 } from '../pkg/photo_fillter';

type Film1ButtonProps = {
    imageFile: File | null;
    setProcessedImage: (img: File) => void;
};

const Film1Button: React.FC<Film1ButtonProps> = ({ imageFile, setProcessedImage }) => {
    useEffect(() => {
        // WASMモジュールの初期化
        init().then(() => {
    ...
    const handleProcessImage = async () => {
        ...
        reader.onload = () => {
            ...
            img.onload = () => {
                ...
                const result = film_effect_1(new Uint8Array(data), width, height);
                // 結果をCanvasに描画
